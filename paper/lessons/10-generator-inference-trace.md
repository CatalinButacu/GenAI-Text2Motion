# Lesson 6 — The inference trace: a prompt becomes motion, value by value

> Now the other direction: text -> motion, every transformation, with shapes. This is the deployed
> path (and the demo). Same symbols as Lesson 5. Code: generator.py `stream`, tokenizer.py `decode`,
...
## The one-line journey (mirror of Lesson 5)
...
2. Which stage is the exact inverse of Stage-3 FSQ rounding from Lesson 5?
