# Matrix cell: RVQ 8x1024 (80 bits/step). Fresh run. seed 2026, 500 ep, eval/25, bs 128.
#   powershell -NoProfile -ExecutionPolicy Bypass -File scripts\run_rvq_l8_1024.ps1
...
& ".venv\Scripts\python.exe" -u -m text2motion.train.train_tokenizer `
    --config configs/rvq_l8_1024.yaml --tokenizer rvq `
