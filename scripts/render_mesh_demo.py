"""Generate motion from a prompt and render the fitted SMPL-X BODY (not skeleton) to a montage PNG
+ animated GIF -- the qualitative "watch it work" check alongside the FID numbers.

prompt -> CLIP -> generator.stream -> FSQ decode -> 22 joints -> joints2smpl fit -> SMPL-X mesh ->
matplotlib trisurf montage (6 frames) + GIF. Headless (Agg), so no GL window needed.

    $env:PYTHONPATH="src"; .venv/Scripts/python.exe scripts/render_mesh_demo.py `
        --prompt "a person walks forward and waves" --tag walk_wave
"""
...
from text2motion.model.generator import MotionGenerator  # noqa: E402
from text2motion.model.text_encoder import CLIPTextEncoder  # noqa: E402
from text2motion.model.tokenizer import ResidualFsqTokenizer  # noqa: E402
from text2motion.render.joints2smpl import FitConfig, fit_smplx_to_joints  # noqa: E402
from text2motion.render.studio import recover_skeleton  # noqa: E402
from text2motion.shared.config import load_config  # noqa: E402
from text2motion.shared.seed import seed_everything  # noqa: E402
from text2motion.stream.decode import StreamingMotionDecoder  # noqa: E402
