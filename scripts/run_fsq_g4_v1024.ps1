# Matrix cell: FSQ 4x1024 (8,8,4,4) (40 bits/step). RESUME from ep286 -> 500. seed 2026, eval/25, bs 128.
#   powershell -NoProfile -ExecutionPolicy Bypass -File scripts\run_fsq_g4_v1024.ps1
...
& ".venv\Scripts\python.exe" -u -m text2motion.train.train_tokenizer `
    --config configs/fsq_g4_v1024.yaml --tokenizer fsq `
