# Matrix cell: FSQ 8x1000 (8,5,5,5) (79.7 bits/step). Fresh run. seed 2026, 500 ep, eval/25, bs 128.
#   powershell -NoProfile -ExecutionPolicy Bypass -File scripts\run_fsq_g8_v1000.ps1
...
& ".venv\Scripts\python.exe" -u -m text2motion.train.train_tokenizer `
    --config configs/tok_g8_v1000.yaml --tokenizer fsq `
