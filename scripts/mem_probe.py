"""Measure the TRUE training memory peak of a generator config on this GPU.

Runs the real training path (tokenize -> generator forward -> soft-decode losses -> backward ->
optimizer step) for one step at a given batch size and reports the peak allocation vs the GPU's
